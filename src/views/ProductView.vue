<template>
  <div class="product">
  <!-- Ini component untuk menjalankan tampilan header -->
  <TheHeader/>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                                            <!-- titik 2 itu artinya v-bind -->
                                <img class="product-big-img" :src="gambar_dafault" alt="" />
                            </div>
                            <div class="product-thumbs">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                              <!-- @click itu method jika di click -->     <!-- :class itu kondisi jika dipilih gambar untuk class aktif -->                      
                                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == gambar_dafault ? 'active' : ''" >
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt"  @click="changeImage(thumbs[1])" :class="thumbs[1] == gambar_dafault ? 'active' : ''">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == gambar_dafault ? 'active' : ''">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt"  @click="changeImage(thumbs[3])" :class="thumbs[3] == gambar_dafault ? 'active' : ''">
   ...
   <!-- Ini component untuk menjalankan tampilan Related Product -->
  <RelatedProduct/>

  <!-- Ini component untuk menjalankan tampilan The Footer -->
  <TheFooter/>
...
export default {
  ...
  //ini untuk memanipulasi data gambar nya yang di atas
  data(){
    return {
